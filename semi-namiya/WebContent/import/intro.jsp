...
<div id="myCarouselV" class="carousel thumbnail fade">
	<div class="carousel-inner">
		...
		<div class="carousel-caption"> 
			<p class="lead" style="white-space: pre-wrap;">남이야 잡화점은 한국소프트웨어기술진흥협회 웹프로그래밍 개발자 과정 훈련생들이
영화<strong class="text-primary"> 『나미야 잡화점의 기적』</strong>을 보고 아이디어를 얻어 
세미프로젝트로 만든 사이트로 영화의 내용처럼 이용자들의 각종 고민을 운영자들이 상담을 해주는 사이트 입니다. 
개발자 과정을걷고있는 훈련생들이 만든 사이트이기 때문에 부족한 부분이 많습니다. 
